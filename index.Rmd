...
* Sign in to the OSF
  ...
  * You will be asked for your user name - it's the BU email address that you used when you registered with the OSF (so mine is mgreen@bournemouth.ac.uk and yours will have the same form)
