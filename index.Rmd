...
* at https://osf.io/register/ (you might need to copy and paste that link into a browser if clicking on it doesn't work)
  ...
  * Use a name that is likely to be unique among thousands of OSF users - your real full name including any middle name is a sensible choice. If you have a name that is likely to exist already, putting 'CAL2021' in it somewhere would be a good idea - so my own name Matt Green could be entered as 'Matt CAL2021 Green' for example.
...
* Email me (mgreen@bournemouth.ac.uk) the real full name that you used to create your account
...
![](turn-off-notifications.png){width=50%}
...
![](opensesame-download-page.png){width=50%}
...
![](os-interface.png){width=50%}

* Grant OpenSesame access to your OSF account

![](os-osf-login-allow.png){width=50%}
...
![](folder-structure.png){width=50%}
![](folder-structure-2.png){width=50%}
...
![](os-cat-dog-opened.png){width=50%}
